...
class NJGameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func prepareStartNodes(screenSize: CGSize) {
        ...
        let player = NJPlayerNode(size: NJGameInfo.playerSize, position: rightWallPlayerPos, texture: SKTexture(imageNamed: "squirrelRunRight"))
    ...
    func spawnFox(obstacleSize: CGSize, yPos: CGFloat) {
        ...
        let obstacle = NJFoxNode(size: obstacleSize, position: CGPoint(x: xPos, y: yPos + NJGameInfo.branchHeight), texture: SKTexture(imageNamed: "foxRight1"))
